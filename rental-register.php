...
<div class="container">
  ...
  <form method="POST" enctype="multipart/form-data" onsubmit="return Validate()">
    ...
    <hr>
    <center><button id="submit" name="rental_register" class="btn btn-primary btn-block" style="background-color:#b16bea">Register</button></center><br>
    <div class="form-group text-right">
      <label class="" >Register as a <a href="owner-register.php" style="color:#b16bea">Owner</a>?</label><br>
    </div><br><br>
  </form>
</div>
